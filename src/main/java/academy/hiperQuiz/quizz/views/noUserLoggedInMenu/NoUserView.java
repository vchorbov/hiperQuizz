        ...
        switch (command) {
            ...
            case 1: //login with existing account
                while (command != 0 ) {
                    ...
                    try {
                        placeholder = userRepository.findUserByUsername(usernameIn.trim()).orElseThrow(()->
            ...
            case 2: //create new account(Register)
                ...
                // TODO: Implement a logic for the registration of new user -> reuse the existing methods from package java.course.hiperQuiz.quizz.util.creators;
                break;
        }
